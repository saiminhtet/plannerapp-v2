...
{
    public class RegisterRequestsValidator : AbstractValidator<RegisterRequest>
    {
        public RegisterRequestsValidator()
        {
            RuleFor(p => p.Email)
                .NotEmpty()
            ...
            RuleFor(p => p.ConfirmPassword)
                .Equal(p => p.Password)
                .WithMessage("ConfirmPassword doesn't match the password");
        }
    }
}
